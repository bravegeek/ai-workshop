...
This is where enhancements, new features, and design iterations for the agent are developed and tested before being merged into the official agent location at `.claude/agents/satirical-article.md`.

## Official Agent Location

The production agent lives at:
```
.claude/agents/satirical-article.md
```
...
- `satirical-article.md` - Development version of the agent prompt
...
3. When ready, merge enhancements back to `.claude/agents/satirical-article.md`
