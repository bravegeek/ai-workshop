...
## III. Symptoms of Accumulation

Symptoms divide into two categories with different implications:

**Perceptual** — the Psychosphere bleeding into waking perception. Manageable. Sometimes useful. A diver with mild perceptual thinning perceives emotional histories of places, reads rooms, senses things others cannot. Occupational advantage up to a point.

**Identity** — losing the boundary between self and absorbed experience. The dangerous category. Not what you see, but who is doing the seeing.

### Early Stage — The Pleasant Phase
This is where recreational use lives. Why people come back.
- Hypnagogia bleeds into waking hours — the visual shimmer of sleep onset appears briefly during the day
- Dreams feel more real than waking life for days after use
- Heightened empathy — picking up emotional states from nearby people with unusual clarity
- Colors more saturated, sounds more textured, the world has depth it didn't before
- Enhanced pattern recognition and creativity
- Sleeping feels *crowded* — more signal coming through than usual

### Mid Stage — The Useful and the Worrying
- Waking dreams — fully formed sequences intruding into conscious experience for seconds at a time, then dissolving
- The world develops a **second layer** — reality feeling thin, something pressing through from underneath
- Emotional bleed from others becomes intrusive: not sensing their mood but briefly experiencing it as your own
- Sleep paralysis increasing in frequency
- Temporal confusion — some moments feel ancient, some feel future, the present feels uncertain
- Objects develop weight — Symbolic Legacy of things perceptible in the waking world, not just the Deep
- Difficulty with sustained attention; the dreaming mind keeps pulling

### Late Stage — The Dangerous Threshold
- Involuntary Psychosphere entry during sleep — going deep without equipment, without a rig, without intending to
- Memory boundary dissolution: which memories are mine, which did I absorb?
- Hearing the Hum in waking life — the low-level signal of nearby Drifts, audible above ground
- Nightwalking — physically moving through the waking world while partially in the Psychosphere
- Proprioceptive uncertainty — the body in space feels unreliable
- Complete dissolution episodes — minutes where the person is fully in the Psychosphere while physically awake

### Terminal Stage — Nia
- The barrier no longer exists
- The person follows whatever signal is loudest
- The Sleeping God's frequency becomes audible at this stage — the most powerful signal in the Psychosphere, always broadcasting
- Walking into the Deep permanently because they are already half there

---

## IV. Recovery: Two Phases
...
## V. Treatment: The Eye Protocol

### What the Lethe-Light Can Do
If thinning is structural neuroplasticity, the Lethe-Light offers a potential Phase 2 intervention. Memory reconsolidation (real neuroscience): when a memory is actively recalled, it becomes temporarily malleable before being re-stored. The Light bleaches what is most active. If the patient surfaces the rewired pathways — consciously activating the thin-barrier state — the Light can target the structural memory of that configuration and erase it.
...
- The Monocle (IO's anti-mesmerism filter) partially attenuates the Light, allowing more surgical application — IO is currently the only person who can perform the procedure with any precision
- Time dilation at the Eye (1 min = 1 hour) means the procedure is subjectively long; the patient relives the target experiences in extended time while the Light bleaches them
- If focus slips, the Light takes something adjacent

### The Cost
Erasing rewired neural pathways is not surgical. Associated content goes with the structure — memories formed during that state, skills developed while thinned, knowledge acquired through the thinned barrier.

For a recreational user: manageable.

For IO: catastrophic. Her best cartography, her deepest dives, her accumulated knowledge of the Psychosphere were all built while partially thinned. The cure costs the map.

### IO's Position
She suspects the thinning. After Nia, she knows exactly what cumulative exposure looks like at its endpoint. She monitors herself, has not acted. Doing something means surrendering the ground she has spent years building. She continues because stopping means losing the search.

---

## VI. The Cistern as Rehabilitation Facility

The Cistern has all the components for a full recovery protocol:
...
The constraint: clients mean visitors. Visitors mean security risk. The Cistern's value depends on remaining secret. Every client who knows where it is and what it can do is a vulnerability.
