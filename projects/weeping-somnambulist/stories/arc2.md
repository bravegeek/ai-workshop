...
Healing and rebuilding — but healing as the container for the story, not the story itself. The crew heals *while* the story happens to them.
...
**The suppressed thing in the Vault** — slow-burn ticking clock. When the Eye reintegrated, something it was containing is now simply present. The dodecagonal geometry still imposes order. This is different from order imposed by the Eye. Patient, building, unidentified. Doesn't feel like a clock until it does.

**Budapest cases escalating** — IO is helping people who are grazing oubliettes until one breaks through into something the half-rebuilt crew has to stop before they're ready. Healing tested before it's complete.
...
**The Architect Reliquaries** — the pre-Eye Vault audit surfaces the Architects' Witnesses: small brass instruments, locket cases, clock movements — objects that belonged to specific people, carried specific things, accumulated specific histories over years of use. After 150 years the personal significance that bound them is gone, dissolved with their owners. But the carried history remains, layered and illegible without context. The impressions inside are the Architects' actual experience — not their notes, not what they chose to document, but what they carried back from the Deep before the Lethe-Light took everything. The pre-Eye Reliquaries especially hold what was never written down. Ren is drawn to them immediately: they are archives. The danger is that a Reliquary whose original anchor has dissolved will bond to whoever handles it with unusual speed — it reads the new contact as its anchor and begins accumulating them. Picking one up is not neutral. What it was carrying comes with it.
...
**The accidental development — the scene that kicks off water memory.** Artifact development requires three steps: the mnemonic object holds the pattern, storm-charged Cistern water develops it into physical reality, and the Eye's Lethe-Light acts as stop bath — halting development and clearing psychosphere residue from the water. Without the Eye, there is no stop bath. IO knows this. She hasn't said it clearly enough, or Ren isn't waiting. During a storm in the early rebuild, Ren puts a mnemonic object into the pool — something recovered during the pre-Eye Vault audit, something she thinks is simple enough to risk. The artifact develops. Then keeps developing. The pattern doesn't fix — it keeps absorbing: the storm energy, the 150-year residue in the water, the TSG imprint the pool now carries. What surfaces isn't what went in. It's more. It may be extraordinary. It is definitely not what was intended. This is the first hard evidence that the Cistern water is not what IO built it to be — that the pool accumulated something during its long proximity to the Eye. The accidental development and the water memory discovery are the same scene. IO arrives to find what came out of the pool and understands immediately what happened and what it means. This is what pulls her back to the bench.
...
## Budapest in the Aftermath

The Eye's logic field organized psychic pressure above the city for 150 years. Its absence is felt. The ley line confluence is still there — now unmanaged. The local Psychosphere gets louder and shallower. People in the Buda districts notice without knowing why:
- Sleep disorders spike
- People with naturally thin barriers graze oubliettes they have no framework for — recurring nightmares in wrong languages, textures that don't belong to their lives
- A handful get stuck in the bleed — not inside, not outside, pressing against a shell they can't name
- Children and sensitives have experiences nobody around them believes

**IO's redirection:** Not wealthy clients, not espionage. People who can't pay, who don't know what's wrong, who just need someone to tell them they're not losing their minds. The IPE work she was doing quietly, now above ground and local. Every case also feeds the rebuild — data about which oubliettes are active, where unmanaged pressure concentrates, what the Blooming's aftermath looks like from the inside out.
