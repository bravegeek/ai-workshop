...
img-prompt = 'Satirical illustration: A dark corporate boardroom. At the head of the table sits a shadowy figure in a black hoodie (the "Antifa Manager"). On a laptop screen in front of them is a video call showing Kristi Noem with a "Karen" haircut, pointing and yelling angrily. The manager looks bored.'
+++
