...
slug = 'waymo-charges-newborn-extra-rider-fee'
image = 'waymo-newborn-fee.jpg'
alt = 'A Waymo car\'s infotainment screen showing an extra fee for a newborn baby against a blurred background of exhausted parents holding the infant.'
tags = ['technology', 'satire', 'automotive', 'corporate']
description = "A couple's joy of a mid-ride birth turns into a customer service nightmare when their Waymo taxi classifies their newborn as an 'unauthorized additional passenger,' automatically charging an extra rider fee. The company defends the charge, citing strict capacity policies and launching a cynical new 'Stork Plus' tier for pregnant riders."
img-prompt = 'A hyper-realistic, cinematic interior shot from the backseat of a pristine Waymo Jaguar I-PACE at dusk. In the soft, sterile ambient LED lighting of the car\'s ceiling, a disheveled and exhausted couple holds a newborn baby wrapped in a flannel shirt. The focus, however, is on the bright, glowing infotainment screen in the foreground, which displays a crisp, cheerful notification: \'RIDER COUNT UPDATED: +1. EXTRA FEE APPLIED.\' The contrast between the intimate, messy human moment in the blurred background and the cold, sharp digital interface in the foreground is striking. Streetlights streak by outside the window. Shot on 35mm lens, f/1.8, high contrast, documentary style.'
+++
